...
export class EdgeFunctionsRegistryImpl {
    ...
    projectDir;
    command;
    constructor({ aiGatewayContext, bundler, command, config, configPath, env, featureFlags, getUpdatedConfig, importMapFromTOML, projectDir, runIsolate, servePath, deployEnvironment, }) {
